...
|-------|-------|---------|--------------|
| #2573 | move-task --to for_review runs a synchronous multi-minute pre-review gate that reads as a hang | fixed | lane commit `eb939d7ff`; WP01 cycle-2 review: 80 focused tests passed |
